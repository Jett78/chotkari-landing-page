        ...
        < footer className="ck-footer-section-container dark:bg-gray-900" id='footer' >
            <div className="container p-6 mx-auto">
                    ...
                    <div className="mt-6 lg:mt-0 lg:flex-1">
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
                            ...
                            <div className='flex-2 ck-socials'>
                                ...
                                <a href="https://www.linkedin.com/in/chotkari/" target="_blank" className="flex justify-start items-center block mt-2 text-sm text-white dark:text-white hover:underline"><FaLinkedin />LINKEDIN</a>
                            </div>
                            <div className='flex-1'>
                ...
                <div className='ck-bottom-content'>
                    ...
                    <p className="text-white dark:text-white footer-text"> <a className="text-white dark:text-white footer-text text-underline" href='/privacy-policy'>Privacy Policy</a> | © 2080 Chotkari All rights reserved</p>
                </div>
            </div>
        </footer >
    )
